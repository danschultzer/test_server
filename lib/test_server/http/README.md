...
```elixir
TestServer.HTTP.start(http_server: {TestServer.HTTP.Server.Bandit, []})
```

You can create your own plug based HTTP Server Adapter by using the `TestServer.HTTP.Server` behaviour.
